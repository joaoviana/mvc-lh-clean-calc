...
// read_history: reads history and passes to view. refactor operate to save each call to the model as a string
let controller = {
...
// render_history: renders an array of strings to the history space
let view = {
